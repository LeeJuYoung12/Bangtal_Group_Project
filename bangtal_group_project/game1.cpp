...
int g1_skeleton3_x[32] = { 0,150,0,0,0,0,84,84,168,380,380,380,380,380,380,380,542,542,542,542,542,542,542,461,780,860,940,1020,1100,785,1100,785 };
int g1_skeleton3_y[32] = { 130,220,310,460,550,640,460,640,640,640,550,460,370,280,190,100,640,550,460,370,280,190,100,640,0,637,0,637,0,500,400,300 };
int g1_skeleton3_xb[32] = { 0,150,0,0,0,0,84,84,168,380,380,380,380,380,380,380,542,542,542,542,542,542,542,461,780,860,940,1020,1100,785,1100,785 };
int g1_skeleton3_yb[32] = { 130,220,310,460,550,640,460,640,640,640,550,460,370,280,190,100,640,550,460,370,280,190,100,640,0,637,0,637,0,500,400,300 };
int g1_box_xs3[6] = { 650,650,650,700,700,700 };
int g1_box_ys3[6] = { 0,50,100,0,50,100 };
...
SceneID g1_scene;
ObjectID g1_tree1[24], g1_tree2[50], g1_tree3[38], g1ch, g1_skeleton1[15][8], g1_skeleton2[11][8], g1_skeleton3[32][8], g1_clear_zone, g1_attackeffect[4], g1_boxs2[8], g1_boxs3[6], g1_gomapbutton, g1_restartbutton, g1_nextbutton, g1_deathback, g1_clearback;
TimerID g1_move_t, g1_moveskeleton_t, g1_update_t, g1_effectmove_t, g1_skeletoneimage_t, g1_clearcheck_t;
SoundID g1_boxsound;

ObjectID g1_thorns1[92], g1_thorns2[70], g1_thorns3[42];
...
void g1_install_s3()
{
	...
	for (int i = 0; i < 32; i++)
	{
		g1_skeleton3_x[i] = g1_skeleton3_xb[i];
		g1_skeleton3_y[i] = g1_skeleton3_yb[i];
		for (int j = 0; j < 4; j++)
		{
			g1_skeletonway3[i][j] = g1_skeletonway3b[i][j];
		}
	}

	g1_clear_zone = createObject("image/game1/g1_clearzone.png", g1_scene, 1180, 0, true, 1.f);

	for (i = 0; i < 7; i++)
	{
		g1_tree3[i] = createObject("image/game1/g1_tree1.png", g1_scene, 200, i * 90, true, 1.f);
		g1_tree3[i + 7] = createObject("image/game1/g1_tree1.png", g1_scene, 270, i * 90, true, 1.f);
	}

	for (i = 0; i < 5; i++)
	{
		g1_tree3[i + 14] = createObject("image/game1/g1_tree1.png", g1_scene, 610, 150 + i * 90, true, 1.f);
		g1_tree3[i + 19] = createObject("image/game1/g1_tree1.png", g1_scene, 680, 150 + i * 90, true, 1.f);
	}

	for (i = 0; i < 7; i++)
	{
		g1_tree3[i + 24] = createObject("image/game1/g1_tree1.png", g1_scene, 1150, 100 + i * 90, true, 1.f);
		g1_tree3[i + 31] = createObject("image/game1/g1_tree1.png", g1_scene, 1220, 100 + i * 90, true, 1.f);
	}

	for (i = 0; i < 2; i++)
	{
		g1_thorns3[i] = createObject("image/game1/g1_thorn.png", g1_scene, 75, 560 + i * 25, true, 1);
		g1_thorns3[i + 2] = createObject("image/game1/g1_thorn.png", g1_scene, 100, 560 + i * 25, true, 1);
	}
	for (i = 0; i < 19; i++)
	{
		g1_thorns3[i + 4] = createObject("image/game1/g1_thorn.png", g1_scene, 465, 140 + i * 25, true, 1);
		g1_thorns3[i + 23] = createObject("image/game1/g1_thorn.png", g1_scene, 490, 140 + i * 25, true, 1);
	}

	for (i = 0; i < 6; i++)
	{
		g1_boxs3[i] = createObject("image/game1/g1_box.png", g1_scene, g1_box_xs3[i], g1_box_ys3[i], true, 1);
	}


	for (i = 0; i < 32; i++)
	{
		g1_skeleton3[i][0] = createObject("image/game1/g1_skeleton1.png", g1_scene, g1_skeleton3_x[i], g1_skeleton3_y[i], false, 0.25f);
		g1_skeleton3[i][1] = createObject("image/game1/g1_skeleton2.png", g1_scene, g1_skeleton3_x[i], g1_skeleton3_y[i], false, 0.25f);
		g1_skeleton3[i][2] = createObject("image/game1/g1_skeleton3.png", g1_scene, g1_skeleton3_x[i], g1_skeleton3_y[i], false, 0.25f);
		g1_skeleton3[i][3] = createObject("image/game1/g1_skeleton4.png", g1_scene, g1_skeleton3_x[i], g1_skeleton3_y[i], false, 0.25f);
		g1_skeleton3[i][4] = createObject("image/game1/g1_skeleton5.png", g1_scene, g1_skeleton3_x[i], g1_skeleton3_y[i], false, 0.25f);
		g1_skeleton3[i][5] = createObject("image/game1/g1_skeleton6.png", g1_scene, g1_skeleton3_x[i], g1_skeleton3_y[i], false, 0.25f);
		g1_skeleton3[i][6] = createObject("image/game1/g1_skeleton7.png", g1_scene, g1_skeleton3_x[i], g1_skeleton3_y[i], false, 0.25f);
		g1_skeleton3[i][7] = createObject("image/game1/g1_skeleton8.png", g1_scene, g1_skeleton3_x[i], g1_skeleton3_y[i], false, 0.25f);
	}
...
void g1_blocks3()
{
	...
	if ((g1cx + g1_ch_x < 410 && g1cx + g1_ch_x>230) && g1cy + g1_ch_y < 690) {
		g1cx -= g1dx; g1cy -= g1dy;
	}
	if ((g1cx + g1_ch_x < 820 && g1cx + g1_ch_x>640) && (g1cy + g1_ch_y < 670 && g1cy + g1_ch_y >160)) {
		g1cx -= g1dx; g1cy -= g1dy;
	}
	if ((g1cx + g1_ch_x > 1180) && g1cy + g1_ch_y > 100) {
		g1cx -= g1dx; g1cy -= g1dy;
	}
	if (g1cx > 300)
	{
		for (int i = 0; i < 6; i++) {
			if ((g1cx < (g1_box_xs3[i] + 50)) && (g1cx + g1_ch_x > g1_box_xs3[i]) && (g1cy < (g1_box_ys3[i] + 50)) && (g1cy + g1_ch_y > g1_box_ys3[i])) {
				g1cx -= g1dx; g1cy -= g1dy;
			}
		}
	}
...
void g1_skeletonmoves3()
{
	int i, j;

	if (g1_skeleton3_x[0] >= 145)
	{
		for (i = 0; i < 4; i++)
		{
			g1_skeletonway3[0][i] = 0;
			g1_skeletonway3[1][i] = 0;
			g1_skeletonway3[2][i] = 0;
		}
		g1_skeletonway3[0][2] = 1;
		g1_skeletonway3[1][3] = 1;
		g1_skeletonway3[2][2] = 1;
	}
	else if (g1_skeleton3_x[0] <= 5)
	{
		for (i = 0; i < 4; i++)
		{
			g1_skeletonway3[0][i] = 0;
		...
		g1_skeletonway3[0][3] = 1;
		g1_skeletonway3[1][2] = 1;
		g1_skeletonway3[2][3] = 1;
	}

	for (i = 3; i < 9; i++)
	{
		if (g1_skeleton3_x[i] <= 0 && g1_skeleton3_y[i] <= 460)
		{
			for (j = 0; j < 4; j++)
			{
				g1_skeletonway3[i][j] = 0;
			}
			g1_skeletonway3[i][0] = 1;
		}
		if (g1_skeleton3_x[i] >= 168 && g1_skeleton3_y[i] >= 640)
		{
			for (j = 0; j < 4; j++)
			{
				g1_skeletonway3[i][j] = 0;
			}
			g1_skeletonway3[i][1] = 1;
		}
		if (g1_skeleton3_y[i] >= 640 && g1_skeleton3_x[i] <= 0)
		{
			for (j = 0; j < 4; j++)
			{
				g1_skeletonway3[i][j] = 0;
			}
			g1_skeletonway3[i][3] = 1;
		}
		if (g1_skeleton3_y[i] <= 460 && g1_skeleton3_x[i] >= 168)
		{
			for (j = 0; j < 4; j++)
			{
				g1_skeletonway3[i][j] = 0;
			}
			g1_skeletonway3[i][2] = 1;
		}
	}

	for (i = 9; i < 24; i++)
	{
		if (g1_skeleton3_x[i] <= 380 && g1_skeleton3_y[i] >= 640)
		{
			for (j = 0; j < 4; j++)
			{
				g1_skeletonway3[i][j] = 0;
		...
		if (g1_skeleton3_x[i] <= 380 && g1_skeleton3_y[i] <= 58)
		{
			for (j = 0; j < 4; j++)
			{
				g1_skeletonway3[i][j] = 0;
		...
		if (g1_skeleton3_y[i] <= 58 && g1_skeleton3_x[i] >= 542)
		{
			for (j = 0; j < 4; j++)
			{
				g1_skeletonway3[i][j] = 0;
		...
		if (g1_skeleton3_y[i] >= 640 && g1_skeleton3_x[i] >= 542)
		{
			for (j = 0; j < 4; j++)
			{
				g1_skeletonway3[i][j] = 0;
	...
	if (g1_skeleton3_y[24] >= 637)
	{
		for (i = 0; i < 4; i++)
		{
			g1_skeletonway3[24][i] = 0;
			g1_skeletonway3[25][i] = 0;
			g1_skeletonway3[26][i] = 0;
			g1_skeletonway3[27][i] = 0;
			g1_skeletonway3[28][i] = 0;
		}
		g1_skeletonway3[24][1] = 1;
		g1_skeletonway3[25][0] = 1;
		g1_skeletonway3[26][1] = 1;
		g1_skeletonway3[27][0] = 1;
		g1_skeletonway3[28][1] = 1;
	}
	else if (g1_skeleton3_y[24] <= 0)
	{
		for (i = 0; i < 4; i++)
		{
			g1_skeletonway3[24][i] = 0;
		...
		g1_skeletonway3[24][0] = 1;
		g1_skeletonway3[25][1] = 1;
		g1_skeletonway3[26][0] = 1;
		g1_skeletonway3[27][1] = 1;
		g1_skeletonway3[28][0] = 1;
	}


	if (g1_skeleton3_x[29] >= 1100)
	{
		for (i = 0; i < 4; i++)
		{
			g1_skeletonway3[29][i] = 0;
			g1_skeletonway3[30][i] = 0;
			g1_skeletonway3[31][i] = 0;
		}
		g1_skeletonway3[29][2] = 1;
		g1_skeletonway3[30][3] = 1;
		g1_skeletonway3[31][2] = 1;
	}
	else if (g1_skeleton3_x[29] <= 785)
	{
		for (i = 0; i < 4; i++)
		{
			g1_skeletonway3[29][i] = 0;
		...
		g1_skeletonway3[29][3] = 1;
		g1_skeletonway3[30][2] = 1;
		g1_skeletonway3[31][3] = 1;
	}

	//좌표변경
	for (i = 0; i < 32; i++)
	{
		if (g1_skeletonway3[i][0] == 1)
		{
			g1_skeleton3_y[i] += g1_skeleton_speed;
		}
		else if (g1_skeletonway3[i][1] == 1)
		{
			g1_skeleton3_y[i] -= g1_skeleton_speed;
		}
		else if (g1_skeletonway3[i][2] == 1)
		{
			g1_skeleton3_x[i] -= g1_skeleton_speed;
		}
		else if (g1_skeletonway3[i][3] == 1)
		{
			g1_skeleton3_x[i] += g1_skeleton_speed;
		}
	}
	...
	for (i = 0; i < 32; i++) {
		for (int j = 0; j < 8; j++)
		{
			locateObject(g1_skeleton3[i][j], g1_scene, g1_skeleton3_x[i], g1_skeleton3_y[i]);
		}
	}
}
...
void g1_clear() {
	...
	if (g1_currentsence == 3 && (g1cx >= 1130 && g1cy <= 100)) {
...
void g1_death_s3()
{
	...
	if (g1cx > 300)
	{
		for (i = 0; i < 10; i++)
		{
			g1_exam(465, 140 + i * 50);
			g1_exam(515, 140 + i * 50);
		}
	}
	for (i = 0; i < 4; i++) {
...
void g1_exam(int x, int y)
{
	if ((g1cx + 9 <= x && g1cx + 45 >= x) && (g1cy + 5 <= y && g1cy + 58 >= y))
	{
...
void g1_restart() {
	...
	if (g1_currentsence == 3)
	{
		for (int i = 0; i < 6; i++)
		{
			g1_box_xs3[i] = g1_box_xs3b[i];
			g1_box_ys3[i] = g1_box_ys3b[i];
			locateObject(g1_boxs3[i], g1_scene, g1_box_xs3[i], g1_box_ys3[i]);
		}
	}
...
void game1_mouseCallback(ObjectID object, int x, int y, MouseAction action) {
	if (object == g1_gomapbutton) {
		...
		else if (g1_currentsence == 3)
		{
			for (int i = 0; i < 42; i++)
			{
				hideObject(g1_thorns3[i]);
			}
			for (int i = 0; i < 38; i++)
			{
				hideObject(g1_tree3[i]);
			}
			for (int i = 0; i < 32; i++)
			{
				for (int j = 0; j < 8; j++)
				{
					hideObject(g1_skeleton3[i][j]);
				}
			}
			for (int i = 0; i < 6; i++)
			{
				hideObject(g1_boxs3[i]);
			}
			hideObject(g1_clear_zone);
			g1_install_s3();
			if (g1_clearcheck == 1)
...
void game1_timerCallback(TimerID timer) {
	...
	else if (timer == g1_moveskeleton_t && g1_currentsence == 3)
	{
		if (nowgamenum == 1)
		{
			g1_skeletonmoves3();
	...
	else if (timer == g1_skeletoneimage_t && g1_currentsence == 3)
	{
		if (nowgamenum == 1)
		{
			if (g1_timecheck == 0)
			...
			for (int i = 0; i < 32; i++)
			{
				if (g1_skeletonway3[i][0] == 1 && g1_timecheck == 0)
				{
					for (int j = 0; j < 8; j++)
					{
						hideObject(g1_skeleton3[i][j]);
					}
					showObject(g1_skeleton3[i][6]);
				}
				else if (g1_skeletonway3[i][0] == 1 && g1_timecheck == 1)
				{
					for (int j = 0; j < 8; j++)
					{
						hideObject(g1_skeleton3[i][j]);
					}
					showObject(g1_skeleton3[i][7]);
				}

				if (g1_skeletonway3[i][1] == 1 && g1_timecheck == 0)
				{
					for (int j = 0; j < 8; j++)
					{
						hideObject(g1_skeleton3[i][j]);
					}
					showObject(g1_skeleton3[i][0]);
				}
				else if (g1_skeletonway3[i][1] == 1 && g1_timecheck == 1)
				{
					for (int j = 0; j < 8; j++)
					{
						hideObject(g1_skeleton3[i][j]);
					}
					showObject(g1_skeleton3[i][1]);
				}

				if (g1_skeletonway3[i][2] == 1 && g1_timecheck == 0)
				{
					for (int j = 0; j < 8; j++)
					{
						hideObject(g1_skeleton3[i][j]);
					}
					showObject(g1_skeleton3[i][2]);
				}
				else if (g1_skeletonway3[i][2] == 1 && g1_timecheck == 1)
				{
					for (int j = 0; j < 8; j++)
					{
						hideObject(g1_skeleton3[i][j]);
					}
					showObject(g1_skeleton3[i][3]);
				}

				if (g1_skeletonway3[i][3] == 1 && g1_timecheck == 0)
				{
					for (int j = 0; j < 8; j++)
					{
						hideObject(g1_skeleton3[i][j]);
					}
					showObject(g1_skeleton3[i][4]);
				}
				else if (g1_skeletonway3[i][3] == 1 && g1_timecheck == 1)
				{
					for (int j = 0; j < 8; j++)
					{
						hideObject(g1_skeleton3[i][j]);
					}
					showObject(g1_skeleton3[i][5]);
				}
			}
		}
		setTimer(g1_skeletoneimage_t, 0.25f);
