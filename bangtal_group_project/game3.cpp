...
SceneID g3_scene;
ObjectID g3_gomapbutton, g3_restartbutton, g3_nextbutton, g3_deathback, g3_clearback, g3_startbutton, g3_endgame;
...
void game3_main() {
		...
		g3_nextbutton = createObject("image/next.png", g3_scene, 700, 200, false, 1.3f);
		...
		scaleObject(*g3_portal->gameObject, 0.1f);
		g3_portal->setState(false);
